...
namespace Inspection
{
    class DeviceHelper
    {
        ...
        public static void EnableMouse(bool enable)
        {
            ...
            //ACPI\\PNP0F13\\4&1CFD68DB&0
            //PCI\VEN_13FE&DEV_000E&SUBSYS_A1010002&REV_03\4&363FB7&0&00E0

            DeviceHelper.SetDeviceEnabled(mouseGuid, instancePath, enable);
        }
        public static void EnableSerial(bool enable)
        {
            // every type of device has a hard-coded GUID, this is the one for mice
            Guid PortGuid = new Guid("{4d36e96f-e325-11ce-bfc1-08002be10318}");
            //Guid[] ports = GetGuidFromName("Ports");
            // get this from the properties detailes dialog box of this device in Device Manager
            //string instancePath = @"ACPI\PNP0F03\4&3688D3F&0";
            //string instancePath = @"HID\VID_17EF & PID_608D\6 & 11E557F3 & 0 & 0000";

            // string instancePath = @"PCI#VEN_13FE&DEV_000E&SUBSYS_A1010002&REV_03\5&2BEF42CF&5&00E0#CHILD01";
            //PCI\VEN_13FE&DEV_000E&SUBSYS_A1010002&REV_03\4&363FB7&0&00E0
            string instancePath = @"PCI\VEN_13FE&DEV_000E&SUBSYS_A1010002&REV_03\4&363FB7&0&00E0";
            Test();

            DeviceHelper.SetDeviceEnabled(PortGuid, instancePath, enable);
        }
        ...
        internal class SafeDeviceInfoSetHandle : SafeHandleZeroOrMinusOneIsInvalid
        {
            ...
            {
            //HID\\VID_17EF&PID_608D\\6&11E557F3&0&0000
            //ACPI\\PNP0F13\\4&1CFD68DB&0
            const int ERROR_INSUFFICIENT_BUFFER = 122;
                for (int index = 0; index <= diData.Length - 1; index++)
                {
                    ...
                    if (result == false)
                        throw new Win32Exception();
                    if (instanceId.Replace(" ", "").Equals(sb.ToString().Replace(" ","")))
                    {
                        return index;
                    }
                }
